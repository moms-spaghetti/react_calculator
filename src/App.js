      ...
      <section className="calculator-container">
        ...
        <section className="components-container">
          <section className="left-container">
            <Button buttonType={"number-button"} buttonData={numberButtons} handleClick={captureSum} />
          </section>
          <section className="right-container">
            <Button buttonType={"operator-button"} buttonData={operatorButtons} handleClick={captureSum} />
          </section>
        </section>
      </section>
    </main>
